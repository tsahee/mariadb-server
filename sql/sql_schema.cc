...
Schema        mariadb_schema({STRING_WITH_LEN("mariadb_schema")});
Schema_oracle oracle_schema({STRING_WITH_LEN("oracle_schema")});
Schema_maxdb  maxdb_schema({STRING_WITH_LEN("maxdb_schema")});
